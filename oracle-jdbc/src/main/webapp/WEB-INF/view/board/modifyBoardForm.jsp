	...
	<div class="container">
		...
		<form action="${pageContext.request.contextPath}/board/modifyBoard" method="post" id="modifyBoardForm">
			...
			<table class="table" style="font-size : 15pt;">
				...
				<tr>
					<th >TITLE</th>
					<td ><input type="text" style="width:80%" id="boardTitle" name="boardTitle" value="${board.boardTitle}"></td>
				</tr>
				
				<tr>
					<th>CONTENT</th>
					<td><textarea style="width:80%" rows="10" id="boardContent" name="boardContent">${board.boardContent}</textarea></td>
				</tr>
			...
			<div >
				<button type="button" id="modifyBoardBtn" class="btn btn-warning" >수정</button>
			</div>
